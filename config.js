...
var config = {
  ...
  hosts: {
    // XMPP domain.
    domain: "jitsi.parentme360.in",

    // When using authentication, domain for guest users.
    // anonymousdomain: 'guest.example.com',

    // Domain for authenticated users. Defaults to <domain>.
    // authdomain: 'jitsi.parentme360.in',

    // Focus component domain. Defaults to focus.<domain>.
    // focus: 'focus.jitsi.parentme360.in',

    // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
    muc: "conference." + subdomain + "jitsi.parentme360.in",
  },

  // BOSH URL. FIXME: use XEP-0156 to discover it.
  bosh: "https://jitsi.parentme360.in/" + subdir + "http-bind",

  // Websocket URL (XMPP)
  // websocket: 'wss://jitsi.parentme360.in/' + subdir + 'xmpp-websocket',
  ...
  //     // by default uses:
  //     // 'https://jitsi.parentme360.in/static/oauth.html'
  //     redirectURI:
  //          'https://jitsi.parentme360.in/subfolder/static/oauth.html',
  // },
  ...
  p2p: {
    ...
    stunServers: [
      // { urls: 'stun:jitsi.parentme360.in:3478' },
  ...
  // moderatedRoomServiceUrl: 'https://moderated.jitsi.parentme360.in',
  ...
  liveStreamingEnabled: true,
  hiddenDomain: "recorder.jitsi.parentme360.in",
  anonymousOptions: {
    startWithAudioMuted: true,
    startWithVideoMuted: true,
    moderator: false, // Change to true for testing
  },
};
